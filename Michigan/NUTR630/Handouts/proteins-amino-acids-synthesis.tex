...
That means, to generate a single Actin molecule you would need 46 glucose molecules to undergo aerobic glycolysis through the TCA/ETC or 748 glucose molecules to go through anaerobic glycolysis\sidenote{Check the math yourself}. Thats not even accounting for the energy costs needed if any of the essential amino acids need to be made or transported into the cell.  This is one major reason why protein digestion has a very high level of diet-induced thermogenesis, and why energy demands are very high during growth.  The flip side of this is that protein breakdown \sidenote{which we will discuss next lecture} must be only occur under careful control.
