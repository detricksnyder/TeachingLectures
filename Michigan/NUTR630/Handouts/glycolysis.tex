...
The most important regulatory step that controls flow through glycolysis is catalyzed by PFK1\sidenote{For all these reactions G indicates Glucose, F indicates Fructose, GA indicates Glyceraldehyde and PG indicates Phosphoglycerate.}.  This is the first committed step of glycolysis and catalyzes the third step in glycolysis\sidenote{Reaction \ref{eq:pgm}, catalyzed by Phosphoglucose isomerase is a reversible, equillibrium reaction}:
