...
\begin{abstract}
\noindent This review material will cover the roles of insulin and glucagon in normal and pathophyiological states, especially diabetes.  These hormones are the major glucose controlling hormones and are both secreted from the pancreas. 
\end{abstract}
...
Glucose Oxidation & Muscle \\ \midrule
Glycogen Storage/Release                      & Liver and Muscle \\ \midrule
Gluconeogenesis & Liver \\ \midrule
Lipid Storage/Release & Adipocytes and Liver \\ \bottomrule
\end{tabular}
\end{margintable}
...
\newthought{Testosterone}...

\subsection{Hormonal Regulators of Protein Degradation}
Protein breakdown occurs via two mechanisms, proteolysis which targets specific proteins for degradation and autophagy\sidenote{or self-eating} which can target entire organelles.  Both 
