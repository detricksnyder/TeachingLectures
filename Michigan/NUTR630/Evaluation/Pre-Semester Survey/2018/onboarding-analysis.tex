...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x=}\StringTok{""}\NormalTok{,}\DataTypeTok{y=}\StringTok{"Percent"}\NormalTok{,}\DataTypeTok{title=}\StringTok{"Student Experiences"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{ggplot}\NormalTok{(online.data.summary, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y=}\NormalTok{n,}\DataTypeTok{x=}\KeywordTok{reorder}\NormalTok{(Tool,n))) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat=}\StringTok{'identity'}\NormalTok{,}\DataTypeTok{fill=}\NormalTok{color.scheme[}\DecValTok{1}\NormalTok{]) }\OperatorTok{+}
