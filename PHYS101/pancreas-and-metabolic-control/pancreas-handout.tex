...
\newthought{Longer term glucose control is regulated by two other hormones previously discussed, Growth Hormone and Cortisol.}  Both of these hormones cause insulin resistance, preventing glucose uptake into muscle and adipose tissue.  These hormones are elevated during times of growth or stress where it is important to keep circulating glucose available for other functions.
