...
Many hormonal signaling events involve the brain, which could be considered the most complex endocrine organ.  The primary role of the brain is to integrate external sensory cues\sidenote{such as sights, sounds}, conscious thoughts\sidenote{such as stress or fear} with internal signals\sidenote{such as metabolite levels} and to determine the most appropriate response.  The key parts of the brain that are involved in endocrine responses are the hypothalamus and the pituitary (Figure \ref{fig:pituitary-hypothalamus}).
